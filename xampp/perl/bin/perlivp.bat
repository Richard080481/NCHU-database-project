...
#!perl
#line 29
    eval 'exec \Users\richa\Documents\GitHub\NCHU-database-project\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = '\Users\richa\Documents\GitHub\NCHU-database-project\xampp\perl\bin\perl.exe';
