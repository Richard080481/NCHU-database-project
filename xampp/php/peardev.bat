...
FOR %%x IN ("\Users\richa\Documents\GitHub\NCHU-database-project\xampp\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=\Users\richa\Documents\GitHub\NCHU-database-project\xampp\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=\Users\richa\Documents\GitHub\NCHU-database-project\xampp\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=\Users\richa\Documents\GitHub\NCHU-database-project\xampp\php\php.exe"
GOTO :INSTALLED
